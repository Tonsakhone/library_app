...
deleteStaffDialog({required BuildContext context, required String id}) {
  return showDialog(
    context: context,
      ...
      child: BlocConsumer<AddStaffCubit, AddStaffState>(
        listener: (context, state) {
          if (state is Success) {
            ...
            successDialog(
              context: context,
              message: "You have successfully deleted Staff ID : $id",
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text("You are deleting this Staff Account"),
                  const SizedBox(height: 18),
                  CustomButton(
                    text: "Confirm",
                    onPressed: () {
                      context.read<AddStaffCubit>().deleteStaff(id: id);
                    },
                  ),
                ],
              ),
